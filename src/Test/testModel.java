...
public class testModel {
    public static void main(String[] args) {
        ...
        String res = Model.selectQuery("vection4U",Model.tableNameEnum.Users_table.toString(),Model.UsersfieldNameEnum.Username + "," + Model.UsersfieldNameEnum.Password,"1=1");
